        ...
        <div>
            <div className='flex'>
                <div className='panier-container'>
                    ...
                    <p>Le panier bio de <a href="/"> <span style={{ color: 'green' }}>Healthy Farm</span></a>, est composé de 10 kilos de légumes de 11 variétés différentes. Conçu pour répondre aux besoins d'une famille de trois personnes ou d'un couple qui consomme régulièrement des légumes.</p>
                    ...
                    <p>La livraison du Panier de légumes <a href="https://www.passeportsante.net/fr/Actualites/Dossiers/DossierComplexe.aspx?doc=10-bienfaits-bio-sante"> <span style={{ color: 'green' }}>BIO</span></a> de la ferme Healthy Farm est disponible chaque samedi</p>
            ...
            <div className='trouver-nous'>
                ...
                <p>Si vous désirez nous rendre visite, découvrir notre panier de légumes bio ainsi que tout le reste, n’hésitez pas à nous contacter. Nous serons ravi de vous accueillir.</p>
                <p>À très bientôt !</p>
            </div>
        </div>
    )
