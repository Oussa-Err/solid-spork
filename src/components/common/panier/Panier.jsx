            ...
            <div className='container-huile-poulet-oeuf' >
                ...
                <div className='huile-container'>
                    ...
                    <div className='huile-description'>
                        ...
                        <p>L'huile d'olive vierge bio qui est de qualité supérieure issue d'olivier certifié BIO, est obtenue à partir d'une première pression à froid.</p>
                        <Countdown />
                        <p>Savourez cette huile délicieuse en cuisine avec toutes nos garanties de qualités et de purté, en salade ou même sur du pain, tout en bénéficiant de ses nombreux bienfaits pour la santé. Découvrez notre passion pour la qualité et la tradition, et laissez-vous séduire par l'essence pure de l'huile d'olive biologique,
                ...
                <div className='oeuf-container'>
                    ...
                    <div className='oeuf-description'>
                        ...
                        <p>Faites le choix de la nature, de la fraîcheur et du goût authentique en optant pour nos œufs provenant de poules élevées en plein air</p>
